      ...
      <div className={styles.leftPanel}>
        <div className={styles.leftContent}>
          ...
          <div className={styles.socialLinks}>
            ...
            <a href={personalInfo.github} target="_blank" rel="noreferrer" className={styles.socialBtn} title="GitHub">
            ...
            <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className={styles.socialBtn} title="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href={personalInfo.resumeFile} download className={styles.resumeBtn}>
